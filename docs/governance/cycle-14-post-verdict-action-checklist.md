...
**Triggered by:** Codex's `docs/governance/edge-replay-cycle14-diagnosis.md` numerical-findings draft landing.

## Pre-execution: Item 2 — Audit threshold lock verification (RUN BEFORE diagnostic fires)

Before Codex's calibration diagnostic runs, Claude verifies Codex's audit implementations match the locked thresholds from `docs/governance/2026-05-06-cycle-14-charter-calibration-diagnosis.md`. Specifically:
...
Codex authors `docs/governance/edge-replay-cycle14-diagnosis.md` with numerical findings per the locked schema. Claude appends:
...
2. **Cycle-15 scope recommendation** matching the verdict-to-skeleton map in `docs/governance/cycle-15-conditional-charter-skeletons.md` §"Verdict-to-skeleton map." Identifies which skeleton (§A/§B/§C/§D/§E/§F) instantiates.
...
- `docs/governance/cycle-15-conditional-charter-skeletons.md` — Cycle-15 skeletons
- `docs/governance/2026-05-06-cycle-14-sign-error-candidate-trace.md` — Site-by-site code trace
- `docs/governance/edge-replay-cycle14-diagnosis.md` — Cycle-14 diagnosis-doc (FUTURE)
