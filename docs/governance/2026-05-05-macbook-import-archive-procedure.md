...
2. **Wave-2 Branch C selection rubric** uses Codex's `2026-05-04-lever-a1-plus-1-5-legal-analyst-feed-sizing.md` audit which itself reads the MacBook archive at audit time. Branch C operator decisions are made by reading the cycle-3 selection rubric (`2026-05-05-a1plus1-5-branch-c-feed-selection-rubric.md`), not the raw MacBook archive.
