...
.venv/bin/python scripts/edge_replay/scorer_forensics_audit.py \
  ...
  --report docs/governance/edge-replay-cycle17c-e1-report.md
```
...
- `docs/governance/2026-05-07-cycle-17c-first-axis-pick-rationale.md`
- `docs/governance/2026-05-07-cycle-17c-experiment-ledger-schema.md`
- `docs/governance/edge-replay-cycle16e-scorer-forensics.md`
