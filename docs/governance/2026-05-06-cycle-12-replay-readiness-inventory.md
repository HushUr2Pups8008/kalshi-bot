...
The table itself is the deliverable. The interpretation report (`docs/governance/edge-replay-cycle12-report.md`) summarizes which row(s) — if any — pass the threshold.
