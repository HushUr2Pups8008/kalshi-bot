...
- **Codex 2026-05-03 G1 counterfactual** (`docs/_archive/governance/2026-05-03-g1-admittance-counterfactual.md`): 0.04 admits 32/197, 0.03 admits 65/197, but mean predicted edge is 0.001-0.002 and only 1-2 candidates clear `paper_min_edge=0.02`. **Lever B is not a trade-rate lever in expectation** — it's an attribution / calibration lever. Spec details in `2026-05-03-edge-004-lever-b-g1-calibration-design.md`.
