...
- `docs/_archive/governance/2026-05-07-cycle-16e-scorer-forensics-charter.md` — Codex-authored charter (post-hoc review above).
- `docs/_archive/governance/edge-replay-cycle16e-scorer-forensics.md` — Codex E10 report (Claude N6 verdict appendix lands separately).
- `docs/_archive/governance/edge-replay-cycle16d-report.md` "Operator override" — origin authority (ARCHIVED Stream G R52).
- `docs/_archive/governance/cycle-17-conditional-charter-skeletons.md` — Cycle-17 routing (§B/§C un-deferred).
