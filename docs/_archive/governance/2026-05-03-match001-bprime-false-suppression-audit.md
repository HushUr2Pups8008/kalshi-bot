...
- **Codex's prior false-negative audit** (`docs/_archive/governance/2026-05-03-match001-bprime-false-negative-audit.md`, commit `8001a16`) is the load-bearing pre-deploy gate — that audit checks the OTHER axis (false-positive risk that B' over-suppresses currently-kept records).
...
- `docs/_archive/governance/2026-05-03-match001-bprime-false-negative-audit.md` — Codex's complement report
