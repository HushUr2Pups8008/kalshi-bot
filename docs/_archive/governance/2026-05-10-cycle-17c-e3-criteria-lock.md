...
.venv/bin/python scripts/edge_replay/side_flip_counterfactual.py \
  ...
  --write-report docs/_archive/governance/2026-05-10-cycle-17c-e3-flip-sign-counterfactual.md
```
