...
`docs/_archive/governance/edge-replay-cycle12-report.md` is the canonical replay-result document. Codex extends it with a new section "Cycle-13 Expanded Scope Result" that:
...
OR Codex authors a sibling `docs/_archive/governance/edge-replay-cycle13-report.md` — operator preference.
...
- `docs/_archive/governance/2026-05-06-cycle-12-replay-readiness-inventory.md` — Cycle-12 readiness map (24 resolved markets identified)
