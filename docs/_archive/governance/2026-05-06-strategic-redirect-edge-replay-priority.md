...
5. `docs/_archive/governance/edge-replay-cycle12-report.md` — the table + interpretation. Either ranks profitable slices OR explicitly says "no slice has positive replayed EV at our sample size."
...
- `docs/_archive/governance/2026-05-06-post-obs003-skipped-attribution-audit-refresh.md` — 89% zero-edge SKIPPED finding
...
- Future: `docs/_archive/governance/edge-replay-cycle12-report.md` — Cycle-12 deliverable
