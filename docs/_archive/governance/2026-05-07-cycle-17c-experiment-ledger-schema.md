...
| replay_command | n/a — sweep replaced replay. Sweep script: `scripts/edge_replay/g1_admission_sweep.py`. Sweep report: `docs/_archive/governance/2026-05-08-cycle-17c-e2-g1-admission-sweep.md`. |
...
- `docs/_archive/governance/2026-05-07-cycle-17c-charter-single-variable-redesign.md` — charter (rules source).
- `docs/_archive/governance/2026-05-07-cycle-17c-first-axis-pick-rationale.md` — first-axis info-gain table.
- `docs/_archive/governance/edge-replay-cycle16e-scorer-forensics.md` — frozen baseline source.
