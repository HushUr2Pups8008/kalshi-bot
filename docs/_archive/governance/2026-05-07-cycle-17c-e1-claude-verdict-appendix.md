...
If (A): Codex bundles this appendix amendment + sweep script (`scripts/edge_replay/g1_admission_sweep.py` or operator-final path) + sweep report (`docs/_archive/governance/2026-05-08-cycle-17c-e2-g1-admission-sweep.md`) in **one** commit. Operator then picks threshold or abandons.

If (B) or (C): Codex commits E2 criteria-lock under chosen axis. Same locked workflow as E1.

## Cross-links

- `docs/_archive/governance/edge-replay-cycle17c-e1-report.md` — Codex E1 report (this appendix companions).
- `docs/_archive/governance/2026-05-07-cycle-17c-charter-single-variable-redesign.md` — charter (operating rule + 3-revert architectural rule).
- `docs/_archive/governance/2026-05-07-cycle-17c-experiment-ledger-schema.md` — E1 row populated; E2 row populated (`axis_abandoned_before_criteria_lock`); E3 row pending.
- `docs/_archive/governance/2026-05-07-cycle-17c-first-axis-pick-rationale.md` — original info-gain ranking.
