...
**Companion:** `docs/_archive/governance/2026-05-06-strategic-redirect-edge-replay-priority.md` (the redirect that authorized this pivot path).
...
- `docs/_archive/governance/2026-05-06-cycle-12-replay-readiness-inventory.md` — data inventory (confirms 21/24 dossiers at prior)
- `docs/_archive/governance/edge-replay-cycle12-report.md` — replay harness output
