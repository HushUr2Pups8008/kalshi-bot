...
Source: `docs/_archive/governance/2026-05-08-cycle-17c-e2-g1-admission-sweep.md` (`8629681`); E2 ledger row in `2026-05-07-cycle-17c-experiment-ledger-schema.md` (`89c6f4e`).
...
Source: `docs/_archive/governance/2026-05-08-cycle-17c-e3-side-inference-hypothesis-sketch.md` (`6081475`).
...
- `docs/_archive/governance/2026-05-07-cycle-16e-claude-rescope-and-review.md` — production-proxy verification.
- `docs/_archive/governance/cycle-17-conditional-charter-skeletons.md` §C — strategic-pivot skeleton (cycle-17C-redesign instantiates).
- `docs/_archive/governance/2026-05-07-cycle-17c-experiment-ledger-schema.md` — ledger schema (companion doc).
- `docs/_archive/governance/2026-05-07-cycle-17c-first-axis-pick-rationale.md` — first-axis pick + info-gain table (companion doc).
