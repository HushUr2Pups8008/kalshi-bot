...
- locked criteria in `docs/_archive/governance/2026-05-06-cycle-14-charter-calibration-diagnosis.md`
...
`scripts/edge_replay/calibration_audit.py` audited against the 7 charter-locked thresholds in `docs/_archive/governance/cycle-14-post-verdict-action-checklist.md` §"Pre-execution":
...
`docs/_archive/governance/cycle-15-conditional-charter-skeletons.md` §B — **Cycle-15B Extraction-layer rebuild scope** instantiates. No substitution, no blending with §A/C/D/E/F.
...
Per `docs/_archive/governance/2026-05-06-cycle-14-sign-error-candidate-trace.md`, Lane A pass rules out the following candidate sites as systematic 1-line sign errors:
