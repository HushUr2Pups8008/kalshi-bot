...
class TradingBot:
        ...
        if is_event_news_paper_cohort():
            ...
            for market in market_list:
                ...
                if reason:
                    ...
                    kept.append(market)
            market_list = event_news_one_market_per_event(kept)
            log.info(
    ...
    async def _structural_recompute_task(self) -> None:
        ...
        while True:
            ...
            # returns synchronously (e.g. under a mock). A tiny positive sleep
            # keeps timer cancellation deliverable under slower CI schedulers
            # without changing steady-state behavior in the hourly loop.
