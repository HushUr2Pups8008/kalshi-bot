...
def assess_report(report: dict[str, Any]) -> dict[str, Any]:
    ...
    risk_flags = ["missing_resolved_counterfactual_pnl", "missing_latency_slippage_replay"]
    ...
    if evaluated_cases <= 0:
        ...
        recommendation = (
            "Continue shadow/replay only. Add resolved counterfactual P&L and "
            "latency/slippage replay before any live blocking research."
        )
